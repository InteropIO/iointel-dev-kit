...
export const Modal: React.FC<ModalProps> = ({ open, onClose, title, showCloseIcon = false, footer, testId = "modal", children }) => {
    ...
    return createPortal(
        <div
            data-testid={testId}
            role="presentation"
            className="io-assist-root panel-overlay-container fixed inset-0 z-50 flex items-center justify-center bg-black/[0.32]"
            onClick={(e) => {
        ...
        >
            ...
            >
                <div className="flex justify-end items-center gap-2 px-6 pt-6 text-text-black-white text-xl font-weight-550 shrink-0">
